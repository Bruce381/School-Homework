...
CANVAS_WIDTH = 980  # windows_width
CANVAS_HEIGHT = 720  # windows_height
CANVAS_CENTER_X = CANVAS_WIDTH / 2  # in the middle
CANVAS_CENTER_Y = CANVAS_HEIGHT / 2  # in the middle
IMAGE_ENLARGE = 8  # big and small
# color list
...
def draw(main: Tk, render_canvas: Canvas, render_heart: Heart, render_frame=0):
    ...
    main.after(60, draw, main, render_canvas, render_heart, render_frame + 1)
...
if __name__ == '__main__':
    ...
    text1 = Label(root, text="", font=("Helvetica", 18), fg="#c12bec", bg="black")
